    ...
    for i in range(start,end):
        ...
        #for typ in ['']
            for atom in ['C','N','O','CN','CO','NO']:
                filename1 = Pre + 'skempi_point_10/' + folder + '_' + typ + '_' + atom + '1.npy'
                filename2 = Pre + 'skempi_point_10/' + folder + '_' + typ + '_' + atom + '2.npy'
...
def alpha_h0_feature_to_file(start,end,filtration,grid_size):
    ...
    for i in range(start,end):
        ...
        for j in range(grid_number):
            ...
            for atom in ['C','N','O','CN','CO','NO']:
                # binding_mutate
                filename1 = Pre + 'alpha_zero_homology_' + str(filtration) + '/' + folder \
                    + '_binding_mut_' + atom + '1_zero_homology_' + str(filtration) + '.csv'
                filename2 = Pre + 'alpha_zero_homology_' + str(filtration) + '/' + folder \
                    + '_binding_mut_' + atom + '2_zero_homology_' + str(filtration) + '.csv'
                # binding_wild
                filename3 = Pre + 'alpha_zero_homology_' + str(filtration) + '/' + folder \
                    + '_binding_wild_' + atom + '1_zero_homology_' + str(filtration) + '.csv'
                filename4 = Pre + 'alpha_zero_homology_' + str(filtration) + '/' + folder \
                    + '_binding_wild_' + atom + '2_zero_homology_' + str(filtration) + '.csv'
                # mutation_mut
                filename5 = Pre + 'alpha_zero_homology_' + str(filtration) + '/' + folder \
                    + '_mutation_mut_' + atom + '1_zero_homology_' + str(filtration) + '.csv'
                filename6 = Pre + 'alpha_zero_homology_' + str(filtration) + '/' + folder \
                    + '_mutation_mut_' + atom + '2_zero_homology_' + str(filtration) + '.csv'
                # mutation_wild
                filename7 = Pre + 'alpha_zero_homology_' + str(filtration) + '/' + folder \
                    + '_mutation_wild_' + atom + '1_zero_homology_' + str(filtration) + '.csv'
                filename8 = Pre + 'alpha_zero_homology_' + str(filtration) + '/' + folder \
